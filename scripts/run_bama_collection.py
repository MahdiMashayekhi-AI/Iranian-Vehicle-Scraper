...
from config.bama_config import QUERIES, TARGET_PER_COLOR
from scrapers.bama_scraper import BamaScraper
...
def run_for_model(model_name: str, color_queries: dict, manifest: ManifestStore):
    ...
    scraper = BamaScraper(scraped_links_cache=manifest.scraped_ids, headless=False)
